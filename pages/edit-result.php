...
$result = get_record_by_id('results', $result_id);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($student_id <= 0 || $subject_id <= 0 || $class_id <= 0 || empty($academic_year)) {
        ...
        if (update_record('results', $data, $result_id)) {
            header("Location: results.php?success=updated");
            exit();
        } else {
...
<div class="container-fluid p-4">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1 class="mb-1">Edit Result</h1>
            <p class="text-muted">Update student grades and marks</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form method="POST" action="" novalidate>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="student_id" name="student_id" required>
                                    ...
                                    <?php foreach ($students as $stud): ?>
                                        <option value="<?php echo $stud['id']; ?>" <?php echo ($stud['id'] == $result['student_id'] ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="class_id" name="class_id" required>
                                    ...
                                    <?php foreach ($classes as $cls): ?>
                                        <option value="<?php echo $cls['id']; ?>" <?php echo ($cls['id'] == $result['class_id'] ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="subject_id" name="subject_id" required>
                                    ...
                                    <?php foreach ($subjects as $subj): ?>
                                        <option value="<?php echo $subj['id']; ?>" <?php echo ($subj['id'] == $result['subject_id'] ? 'selected' : ''); ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="academic_year" name="academic_year" value="<?php echo htmlspecialchars($result['academic_year']); ?>" required>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="exam_score" name="exam_score" step="0.01" min="0" max="100" value="<?php echo htmlspecialchars($result['exam_score'] ?? ''); ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="continuous_assessment" class="form-label">Continuous Assessment (CA)</label>
                                <input type="number" class="form-control" id="continuous_assessment" name="continuous_assessment" step="0.01" min="0" max="100" value="<?php echo htmlspecialchars($result['continuous_assessment'] ?? ''); ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="assignment" class="form-label">Assignment</label>
                                <input type="number" class="form-control" id="assignment" name="assignment" step="0.01" min="0" max="100" value="<?php echo htmlspecialchars($result['assignment'] ?? ''); ?>">
                            </div>
                        </div>
                        
                        <div class="mb-3">
                            <label for="comments" class="form-label">Comments</label>
                            <textarea class="form-control" id="comments" name="comments" rows="3"><?php echo htmlspecialchars($result['comments'] ?? ''); ?></textarea>
                        </div>
                        
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Result</button>
